...
<body>
    ...
    <div style="margin:60px 0px 0px;padding:40px;height:700px;background-image:url(&quot;assets/img/background for blood donar website.png&quot;);background-size:cover;background-repeat:no-repeat;background-position:center;">
        <h1 class="text-center">BLOOD BANKS NEAR YOU</h1>
        <div class="container site-section" id="welcome">
            <p>A blood bank is a center where blood gathered as a result of blood donation is stored and preserved for later use in blood tranfusion. The term "blood bank" typically refers to a division of a hospital where the storage of blood product occurs
                and where proper testing is performed (to reduce the risk of tranfusion related adverse events). However, it sometimes refers to a collection center, and indeed some hospitals also perform collection.&nbsp;</p>
        </div>
         <form class="myform" action="blood_banks.php" method="post">
        <div class="form-group" style="height:200px;">
            <div class="row" style="height:95px;max-width:100%;margin-top:33px;margin-left:190px;">
                <div class="col-md-4 item">
                    <p style="padding:10px;padding-right:30PX;width:400px;"><strong>SELECT STATE NAME :-</strong></p>
                </div>
                <div class="col-md-4 item" style="margin-left:90px;"><select style="height:42px;padding:10px;margin:0px 0px 15px 20px;width:250px;" class="statename" required><option value="" selected="">Select State Name</option><option value="Arunachal Pradesh">Arunachal Pradesh</option><option value="Assam">Assam</option><option value="Meghalaya">Meghalaya</option><option value="Manipur">Manipur</option><option value="Mizoram">Mizoram</option><option value="Nagaland">Nagaland</option><option value="Sikkim">Sikkim</option><option value="Tripura">Tripura</option></select></div>
            </div>
      ...
      <div class="modal-dialog" style="width:70%">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title" style="text-align: center;">All the Blood Bank of Selected State</h4>  
                </div>  
	...
	<script>
			$(document).ready(function(){
					...
					$("select.statename").change(function(){
							selectedStateName = $(this).children("option:selected").val();
							//alert("You have selected the country - " + selectedStateName);
					});
					...
					$('.view_data').click(function(){
						...
						$.ajax({
							url:"select3.php",
							method:"post",
							data:{selectedStateName:selectedStateName},
